...
class ConfigLightHouse:
    ...
    FILE_EPISODES_INITIAL_POSITIONS = "maps/lighthouse_map_large.txt"
    FILE_TEST_INITIAL_POSITIONS = "maps/lighthouse_map_large.txt"
    ...
    MAX_STEPS_PER_EPISODE = 600  #problemas/mapas grandes
